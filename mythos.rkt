...
(define MONSTER-2-1 (make-monster 0 DAGON (initial-posn 6)))
(define MONSTER-2-2 (make-monster 1 DAGON (initial-posn 7)))
(define MONSTER-2-3 (make-monster 2 DAGON (initial-posn 8)))
(define MONSTER-2-4 (make-monster 3 DAGON (initial-posn 9)))
(define MONSTER-2-5 (make-monster 4 DAGON (initial-posn 10)))
(define MONSTER-2-6 (make-monster 5 DAGON (initial-posn 11)))
(define MONSTER-3-1 (make-monster 0 SHUB-NIGGURATH (initial-posn 12)))
(define MONSTER-3-2 (make-monster 1 SHUB-NIGGURATH (initial-posn 13)))
(define MONSTER-3-3 (make-monster 2 SHUB-NIGGURATH (initial-posn 14)))
(define MONSTER-3-4 (make-monster 3 SHUB-NIGGURATH (initial-posn 15)))
(define MONSTER-3-5 (make-monster 4 SHUB-NIGGURATH (initial-posn 16)))
(define MONSTER-3-6 (make-monster 5 SHUB-NIGGURATH (initial-posn 17)))
(define MONSTER-4-1 (make-monster 0 KASSOGHTA (initial-posn 18)))
(define MONSTER-4-2 (make-monster 1 KASSOGHTA (initial-posn 19)))
(define MONSTER-4-3 (make-monster 2 KASSOGHTA (initial-posn 20)))
(define MONSTER-4-4 (make-monster 3 KASSOGHTA (initial-posn 21)))
(define MONSTER-4-5 (make-monster 4 KASSOGHTA (initial-posn 22)))
(define MONSTER-4-6 (make-monster 5 KASSOGHTA (initial-posn 23)))
(define MONSTER-5-1 (make-monster 0 BROWN-JENKIN (initial-posn 24)))
(define MONSTER-5-2 (make-monster 1 BROWN-JENKIN (initial-posn 25)))
(define MONSTER-5-3 (make-monster 2 BROWN-JENKIN (initial-posn 26)))
(define MONSTER-5-4 (make-monster 3 BROWN-JENKIN (initial-posn 27)))
(define MONSTER-5-5 (make-monster 4 BROWN-JENKIN (initial-posn 28)))
(define MONSTER-5-6 (make-monster 5 BROWN-JENKIN (initial-posn 29)))
